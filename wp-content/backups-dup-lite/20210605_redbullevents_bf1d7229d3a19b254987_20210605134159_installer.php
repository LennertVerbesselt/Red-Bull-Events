...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210605_redbullevents_bf1d7229d3a19b254987_20210605134159_archive.zip';
	const ARCHIVE_SIZE		 = '63953320';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'bf1d722-05134159';
    const SECONDARY_PACKAGE_HASH = '110e75b-05134159';
	const VERSION			 = '1.4.1';
