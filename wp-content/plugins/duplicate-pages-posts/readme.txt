...
Contributors: wpninjasde, jonastietgen, ferryabt
Tags: clone page, clone post, clone custom posts, clone custom post type, duplicate page, duplicate post, duplicate custom posts, duplicate custom post types
...
[Leave a review](https://wordpress.org/support/plugin/duplicate-pages-posts/reviews/?rate=5#new-post), it makes all the difference for us!
